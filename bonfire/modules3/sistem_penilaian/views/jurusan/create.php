...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        <div class="control-group <?php echo form_error('sistem_penilaian_nilai_minimum') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="sistem_penilaian_nilai_minimum" type="text" name="sistem_penilaian_nilai_minimum" maxlength="5" value="<?php echo set_value('sistem_penilaian_nilai_minimum', isset($sistem_penilaian['sistem_penilaian_nilai_minimum']) ? $sistem_penilaian['sistem_penilaian_nilai_minimum'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('sistem_penilaian_nilai_maksimum') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="sistem_penilaian_nilai_maksimum" type="text" name="sistem_penilaian_nilai_maksimum" maxlength="5" value="<?php echo set_value('sistem_penilaian_nilai_maksimum', isset($sistem_penilaian['sistem_penilaian_nilai_maksimum']) ? $sistem_penilaian['sistem_penilaian_nilai_maksimum'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('sistem_penilaian_grade') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="sistem_penilaian_grade" type="text" name="sistem_penilaian_grade" maxlength="2" value="<?php echo set_value('sistem_penilaian_grade', isset($sistem_penilaian['sistem_penilaian_grade']) ? $sistem_penilaian['sistem_penilaian_grade'] : ''); ?>"  />
        ...
        <div class="control-group <?php echo form_error('sistem_penilaian_bobot_nilai') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="sistem_penilaian_bobot_nilai" type="text" name="sistem_penilaian_bobot_nilai" maxlength="3" value="<?php echo set_value('sistem_penilaian_bobot_nilai', isset($sistem_penilaian['sistem_penilaian_bobot_nilai']) ? $sistem_penilaian['sistem_penilaian_bobot_nilai'] : ''); ?>"  />
...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create Sistem Penilaian" />
