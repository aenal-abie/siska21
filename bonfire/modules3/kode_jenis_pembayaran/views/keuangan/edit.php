...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Edit Kode Jenis Pembayaran" />
    ...
    <?php if ($this->auth->has_permission('Kode_Jenis_Pembayaran.Keuangan.Delete')) : ?>
            ...
            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('kode_jenis_pembayaran_delete_confirm'); ?>')">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('kode_jenis_pembayaran_delete_record'); ?>
            </button>
