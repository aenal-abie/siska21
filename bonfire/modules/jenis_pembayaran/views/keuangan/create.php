...
var alias;
$(this).ready( function() {
    alias = $('#alias_jenis_pembayaran').val();
    if(alias=='0') 
    {
        $('#alias').show();    
    } else 
    {
     ...
     $('#alias_jenis_pembayaran').change(function(){
	alias = $('#alias_jenis_pembayaran').val();
...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <span class="add-on">Rp.</span><input id="jumlah" class="span2" type="text" name="jumlah" maxlength="10"  value="<?php echo set_value('jumlah', isset($jenis_pembayaran['jumlah']) ? $jenis_pembayaran['jumlah'] : ''); ?>" onkeyup="formatNumber(this);" onchange="formatNumber(this);  />
