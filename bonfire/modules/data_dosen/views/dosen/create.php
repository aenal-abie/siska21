...
<?php $options = array(
        ...
        <?php echo form_dropdown('data_dosen_jenis_kelamin', $options, set_value('data_dosen_jenis_kelamin', isset($data_dosen['data_dosen_jenis_kelamin']) ? $data_dosen['data_dosen_jenis_kelamin'] : ''), 'Jenis Kelamin'. lang('bf_form_label_required'))?>
...
<?php $options = array(
        ...
        <?php echo form_dropdown('data_dosen_agama', $options, set_value('data_dosen_agama', isset($data_dosen['data_dosen_agama']) ? $data_dosen['data_dosen_agama'] : ''), 'Agama'. lang('bf_form_label_required'))?>        <div class="control-group <?php echo form_error('data_dosen_alamat') ? 'error' : ''; ?>">
...
<?php $options = array(
        ...
        <?php echo form_dropdown('data_dosen_propinsi', $options, set_value('data_dosen_propinsi', isset($data_dosen['data_dosen_propinsi']) ? $data_dosen['data_dosen_propinsi'] : ''), 'Propinsi'. lang('bf_form_label_required'))?>        <div class="control-group <?php echo form_error('data_dosen_kodepos') ? 'error' : ''; ?>">
        ...
        <div class="control-group <?php echo form_error('data_dosen_foto') ? 'error' : ''; ?>">
            ...
            <div class='controls'>
        <input id="data_dosen_foto" type="file" name="data_dosen_foto" value="<?php echo set_value('data_dosen_foto', isset($data_dosen['foto']) ? $data_dosen['foto'] : ''); ?>"  />
...
<?php $options = array(
        ...
        <?php echo form_dropdown('data_dosen_status', $options, set_value('data_dosen_status', isset($data_dosen['data_dosen_status']) ? $data_dosen['data_dosen_status'] : ''), 'Status'. lang('bf_form_label_required'))?>
...
<?php $options = array(
        ...
        <?php echo form_dropdown('data_dosen_status_perwalian', $options, set_value('data_dosen_status_perwalian', isset($data_dosen['data_dosen_status_perwalian']) ? $data_dosen['data_dosen_status_perwalian'] : ''), 'Status Perwalian'. lang('bf_form_label_required'))?>


        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create Data Dosen" />
