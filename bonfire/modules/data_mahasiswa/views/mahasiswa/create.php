...
<?php $options = array(
        ...
        <?php echo form_dropdown('data_mahasiswa_propinsi', $options, set_value('data_mahasiswa_propinsi', isset($data_mahasiswa['propinsi']) ? $data_mahasiswa['propinsi'] : ''), 'Propinsi'. lang('bf_form_label_required'))?>        <div class="control-group <?php echo form_error('data_mahasiswa_telepon') ? 'error' : ''; ?>">
...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create Data Mahasiswa" />
