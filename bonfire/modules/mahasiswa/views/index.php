<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Mahasiswa.Mahasiswa.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				...
				<tr>
					<td colspan="9">
						...
						<input type="submit" name="delete" id="delete-me" class="btn btn-danger" value="<?php echo lang('bf_action_delete') ?>" onclick="return confirm('<?php echo lang('mahasiswa_delete_confirm'); ?>')">
					</td>
				</tr>
				<?php endif;?>
			</tfoot>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Mahasiswa.Mahasiswa.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/mahasiswa/mahasiswa/edit/'. $record->nim, '<i class="icon-pencil"></i>'  ); echo "&nbsp;&nbsp;" . $record->npm ?></td>
				<?php else: ?>
