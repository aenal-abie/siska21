...
for($counter=1; $field_total >= $counter; $counter++)
{
    ...
    $field_name_edit = $db_required == 'new' ?  set_value("view_field_name$counter") : set_value("view_field_name$counter");
...
EOT;
    ...
    switch($field_type)
    {
        ...
        case('textarea'):
            ...
            $view .= "
            <?php echo form_textarea( array( 'name' => '$field_name', 'id' => '$field_name', 'rows' => '5', 'cols' => '80', 'value' => set_value('$field_name', isset(\${$module_name_lower}['{$field_name_edit}']) ? \${$module_name_lower}['{$field_name_edit}'] : '') ) )?>";
            $view .= '
...
EOT;
        ...
        <input id="{$field_name}" type="{$type}" name="{$field_name}" {$maxlength} value="<?php echo set_value('{$field_name}', isset(\${$module_name_lower}['{$field_name_edit}']) ? \${$module_name_lower}['{$field_name_edit}'] : ''); ?>"  />
        <span class="help-inline"><?php echo form_error('{$field_name}'); ?></span>
        {$form_input_delimiters[1]}
