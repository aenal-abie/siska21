	...
	<div>
		...
		<fieldset id="module_details">
          ...
          <label class="checkbox" for="contexts_public">
					<input name="contexts[]" id="contexts_public" type="checkbox" value="public" />
            <?php echo lang('mb_form_public'); ?>
					...
					<?php foreach (config_item('contexts') as $context) : ?>
						<label class="checkbox" for="contexts_<?php echo $context; ?>">
							<input name="contexts[]" id="contexts_<?php echo $context; ?>" type="checkbox" value="<?php echo $context ?>"  />
      ...
      <div class="control-group">
		...
		<fieldset style="margin-top: 0" id="db_details">
			...
			<div class="control-group mb_advanced">
				...
				<div class="controls">
					<select name="use_created" id="use_created">
						<?php foreach($truefalse as $val => $label):?>
						<option selected="selected" value="<?php echo $val?>"><?php echo $label?></option>
						<?php endforeach;?>
					</select>
				</div>
			</div>
			...
			<div class="control-group mb_advanced <?php echo form_has_error('created_field') ? 'error' : ''; ?>">
				...
				<div class="controls">
					<input name="created_field" id="created_field" type="text" value="<?php echo set_value("created_field", "tanggal_add"); ?>" />
			...
			<div class="control-group mb_advanced <?php echo form_has_error('modified_field') ? 'error' : ''; ?>">
				...
				<div class="controls">
					<input name="modified_field" id="modified_field" type="text" value="<?php echo set_value("modified_field", "tanggal_edit"); ?>" />
